...
public class ModifyAssuranceDialogController implements Initializable {
    ...
    public ModifyAssuranceDialogController() {
    ...
    private void populateFields() {
        ...
        for (User user : userComboBox.getItems()) {
            if (user.getIdUser() == assurance.getUtilisateurId()) {
                userComboBox.setValue(user);
                break;
            }
        }
        
        typeComboBox.setValue(assurance.getTypeAssurance());
        compagnieField.setText(assurance.getCompagnie());
        numeroPoliceField.setText(assurance.getNumeroPolice());
        montantCouvertureField.setText(assurance.getMontantCouverture().toString());
        franchiseField.setText(assurance.getFranchise().toString());
        primeAnnuelleField.setText(assurance.getPrimeAnnuelle().toString());
        primeMensuelleField.setText(assurance.getPrimeMensuelle().toString());
        dateDebutPicker.setValue(assurance.getDateDebut());
        dateEcheancePicker.setValue(assurance.getDateEcheance());
        modePaiementComboBox.setValue(assurance.getModePaiement());
        statutComboBox.setValue(assurance.getStatut());
        renouvellementAutoCheckBox.setSelected(assurance.isRenouvellementAuto());
        garantiesTextArea.setText(assurance.getGarantiesIncluses());
    }
    ...
    private void handleUpdate() {
        if (validateFields()) {
            try {
                ...
                assurance.setUtilisateurId(userComboBox.getValue().getIdUser());
                assurance.setTypeAssurance(typeComboBox.getValue());
                assurance.setCompagnie(compagnieField.getText().trim());
                assurance.setNumeroPolice(numeroPoliceField.getText().trim());
                assurance.setMontantCouverture(new BigDecimal(montantCouvertureField.getText().trim()));
                assurance.setFranchise(new BigDecimal(franchiseField.getText().trim()));
                assurance.setPrimeAnnuelle(new BigDecimal(primeAnnuelleField.getText().trim()));
                assurance.setPrimeMensuelle(new BigDecimal(primeMensuelleField.getText().trim()));
                assurance.setDateDebut(dateDebutPicker.getValue());
                assurance.setDateEcheance(dateEcheancePicker.getValue());
                assurance.setModePaiement(modePaiementComboBox.getValue());
                assurance.setStatut(statutComboBox.getValue());
                assurance.setRenouvellementAuto(renouvellementAutoCheckBox.isSelected());
                assurance.setGarantiesIncluses(garanties);
                
                assuranceServices.modifier(assurance);
                updated = true;
                closeDialog();
