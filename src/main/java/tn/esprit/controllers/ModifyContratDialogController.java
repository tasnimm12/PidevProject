...
public class ModifyContratDialogController implements Initializable {
    ...
    public ModifyContratDialogController() {
    ...
    private void populateFields() {
        // Select assurance
        for (Assurance a : assuranceComboBox.getItems()) {
            if (a.getId() == contrat.getAssuranceId()) {
                assuranceComboBox.setValue(a);
                break;
            }
        }
        
        numeroContratField.setText(contrat.getNumeroContrat());
        dateSignaturePicker.setValue(contrat.getDateSignature());
        dateFinContratPicker.setValue(contrat.getDateFinContrat());
        
        if (contrat.getDureeContrat() != null) {
            dureeContratField.setText(contrat.getDureeContrat().toString());
        }
        if (contrat.getPlafondAnnuel() != null) {
            plafondAnnuelField.setText(contrat.getPlafondAnnuel().toString());
        }
        if (contrat.getTauxRemboursement() != null) {
            tauxRemboursementField.setText(contrat.getTauxRemboursement().toString());
        }
        if (contrat.getDelaiCarence() != null) {
            delaiCarenceField.setText(contrat.getDelaiCarence().toString());
        }
        
        conseillerField.setText(contrat.getConseillerAttribue());
        statutComboBox.setValue(contrat.getStatut());
        conditionsTextArea.setText(contrat.getConditionsParticulieres());
        exclusionsTextArea.setText(contrat.getExclusions());
        clauseBeneficiaireTextArea.setText(contrat.getClauseBeneficiaire());
        contactsField.setText(contrat.getContacts());
    }
    ...
    private void handleUpdate() {
        if (validateFields()) {
            try {
                ...
                contrat.setAssuranceId(selectedAssurance.getId());
                contrat.setUtilisateurId(selectedAssurance.getUtilisateurId());
                contrat.setNumeroContrat(numeroContratField.getText().trim());
                contrat.setDateSignature(dateSignaturePicker.getValue());
                contrat.setDateFinContrat(dateFinContratPicker.getValue());
                
                contrat.setDureeContrat(dureeContratField.getText().trim().isEmpty() ? null : Integer.parseInt(dureeContratField.getText().trim()));
                contrat.setDelaiCarence(delaiCarenceField.getText().trim().isEmpty() ? null : Integer.parseInt(delaiCarenceField.getText().trim()));
                contrat.setPlafondAnnuel(plafondAnnuelField.getText().trim().isEmpty() ? null : new BigDecimal(plafondAnnuelField.getText().trim()));
                contrat.setTauxRemboursement(tauxRemboursementField.getText().trim().isEmpty() ? null : new BigDecimal(tauxRemboursementField.getText().trim()));
                
                contrat.setConditionsParticulieres(conditionsTextArea.getText().trim());
                contrat.setExclusions(exclusionsTextArea.getText().trim());
                contrat.setClauseBeneficiaire(clauseBeneficiaireTextArea.getText().trim());
                contrat.setConseillerAttribue(conseillerField.getText().trim());
                contrat.setContacts(contactsField.getText().trim());
                contrat.setStatut(statutComboBox.getValue());
                
                contratServices.modifier(contrat);
                updated = true;
                closeDialog();
