...
public class AddInvestissementDialogController implements Initializable {
    ...
    public AddInvestissementDialogController() {
    ...
    private void loadProjets() {
        try {
            ...
            // Custom cell factory to display project name
    ...
    private void handleAdd() {
        ...
        try {
            ...
            Investissement investissement = new Investissement(
                montant, date, modePaiement, statut, selectedProjet.getIdProjet()
            );
            
            investissementServices.ajouter(investissement);
